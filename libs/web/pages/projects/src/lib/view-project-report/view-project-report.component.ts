...
@Component({
  ...
  templateUrl: './view-project-report.component.html',
  styleUrls: ['./view-project-report.component.scss'],
...
export class ViewProjectReportComponent {
  ...
  constructor(private reportService: ReportService, private datePipe: DatePipe, private route: ActivatedRoute) {
...
//   };
  downloadPdf() {
    this.reportService.downloadPdf(this.report())
  }
}
